...
路径：`src/Telepath.Godot/R3/`（`namespace R3`）。Autoload 脚本源码在 `src/Telepath.Godot/Addon/FrameProviderDispatcher.cs`，符号链接到 `samples/Showcase/addons/Telepath/`。
