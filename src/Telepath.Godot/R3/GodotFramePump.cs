...
/// <summary>
/// Shared process/physics pump for the runtime Autoload child and the editor plugin.
/// Keeping this off <see cref="Godot.GodotObject"/> avoids an extra C# node in the editor tree.
/// </summary>
